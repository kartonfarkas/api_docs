...
`Use Cases <http://documentation.emarsys.com/?page_id=357>`_, where we show you a number of typical API-related
scenarios.
...
Requests to the API must be authenticated. The authentication method of the API is X-WSSE, see
:doc:`get_started/authentication`.

Our API is rate limited, please read the details at :doc:`get_started/rate_limiting`.
